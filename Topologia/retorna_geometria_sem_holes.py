...
class ReturnGeometryWithoutHoles(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr("Return geometry without holes for a polygon layer. It works for layers in postgis "
                        "with the gometry field named geom. \n"
                        "The Input layer is one layer with the connection to the database. The Table parameter is the table name. For schema-based databases like postgis, "
