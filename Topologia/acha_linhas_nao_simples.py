...
class FindNotSimpleLines(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr("Find lines that are not simple. A not simple line is a line that has a self-intersection. A not simple multiline "
                       "is a multiline in which at least one of the lines that form it is not simple or in which the lines that form it " "touch at points other than its boundaries. The geometry field must be named geom. \n"
