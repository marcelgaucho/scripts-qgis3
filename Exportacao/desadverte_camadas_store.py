...
class DesadverteCamadasStore(QgsProcessingAlgorithm):
    URL = 'URL'
    USER = 'USER'
    PASSWORD = 'PASSWORD'
    ...
    def createInstance(self):
        return DesadverteCamadasStore()

    def name(self):
        return 'desadverte_camadas_store'

    def displayName(self):
        return 'Desadverte camadas do Store'
    ...
    def shortHelpString(self):
        return ("With a Geoserver URL of featuretypes of a PostGIS datastore, " 
                """plus the user and password of GeoServer, you can disadvert all layers in the Geoserver datastore. 
                Com uma URL featuretypes de um datastore do PostGIS, mais o usuário e senha do GeoServer, você pode desadvertir todas """
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for i, payload in enumerate(payloads):
            ...
            feedback.pushInfo("Camada desadvertida foi " + featuretypes[i])
